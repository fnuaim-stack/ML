# Lab 4: Data Preprocessing for Machine Learning

## Overview
This lab covers the essential steps to clean and prepare raw data for machine learning models using a chocolate sales dataset.
